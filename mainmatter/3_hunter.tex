...
\hugo{I need to evaluate the option of making a new and more reproducible and rigorous validation of Hunter. This first evaluation was make with the first paper and I am not very pleased with the procedure and the lack of proper methodology.}
...
Since one of the main goals of this thesis is to analyze compliance with GDPR requirements regarding international transfers of personal data, the validation was intentionally designed around European jurisdictions rather than as a globally exhaustive evaluation. The experiments were therefore conducted from 29 countries belonging to the European Economic Area (EEA). To emulate communications originating from different European jurisdictions, a commercial VPN provider was used to establish exit nodes in all except one EEA member states. Each validation experiment was repeated from multiple European countries in order to evaluate the behavior of Hunter under different routing conditions and geographic origins. Liechtenstein could not be included in the validation because the selected VPN provider did not provide an exit node in that country.

\hugo{Maybe is counter productive that it was focused in european territory.} \hugo{One of the main weakness of this validation is to have used a VPN for the traceroute instead of RIPE Atlas probes. But I can not make the HTTP request at the same time of executing Hunter if I use RIPE Altas probes as origins because I do not discovered yet how to obtain the headers of an HTTP measurement made from a RIPE Altas probe.} \hugo{Include additional details regarding the VPN provider and measurement repetition strategy}
...
\hugo{Clarify this effect of 100\% accuracy and respect to what effect is considered. Includemore detail about the exact number of repetitions. Maybe a figure table summarizing Positive, Negative, and Indeterminate distributions by country.}
